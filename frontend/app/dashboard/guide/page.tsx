  ...
  return (
    <div className="flex flex-col flex-1 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden p-4">
          ...
          <Card className="mb-2.5">
            <div className="flex items-center gap-3">
              ...
              <Link
                ...
                className="text-xs bg-[#C62828] text-white px-3 py-1.5 rounded-xl font-semibold"
              >
                Valider
              </Link>
            </div>
        ...
        {nonAJour === 0 && pending.length === 0 && (
          <Card className="mb-2.5">
            <div className="flex items-center gap-3">
              <span className="text-2xl">✅</span>
              <div className="flex-1">
                <div className="font-semibold text-sm">Tout est à jour</div>
                <div className="text-xs text-[#6b6b78]">Aucune action requise aujourd&apos;hui</div>
              </div>
            </div>
          </Card>
        )}
        ...
        {canExport ? (
          <Link
            ...
            className="block w-full text-center bg-[#C62828] text-white font-bold text-sm py-3.5 rounded-xl mt-2"
          >
            Exporter les participants
          </Link>
        ) : (
          <Button variant="ghost" disabled full className="mt-2">
